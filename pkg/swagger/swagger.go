...
<div>
	<div class="header">
		<div class="list-container">
			<ul class="list">
				<li><a href="https://api-staging.cery.ai/admin/core/swagger/index.html">Admin</a></li>
				
				<li><a href="https://api-staging.cery.ai/website/garage/swagger/index.html">Garage</a></li>

				<li><a href="https://api-staging.cery.ai/website/equipment-catalog/swagger/index.html">Equipment</a></li>

				<li><a href="https://api-staging.cery.ai/website/user/swagger/index.html">User</a></li>

				<li><a href="https://api-staging.cery.ai/website/telematics/swagger/index.html">Telematics</a></li>
				
				<li><a href="https://api-staging.cery.ai/website/listing/swagger/index.html">Listing</a></li>
			</ul>
		</div>
	</div>
	<div id="{{.DomID}}"></div>
